...
> available
> [Documentation](https://scionresearch.github.io/genomesizeR/index.html).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/ScionResearch/genomesizeR/issues) that might
...
- Open an
  [Issue](https://github.com/ScionResearch/genomesizeR/issues/new).
...
- To see if other users have experienced (and potentially already
  ...
  tracker](https://github.com/ScionResearch/genomesizeR/issues?q=label%3Abug).
...
genomesizeR, **including completely new features and minor improvements
...
- Perform a
  [search](https://github.com/ScionResearch/genomesizeR/issues) to see
...
issues](https://github.com/ScionResearch/genomesizeR/issues).
...
- **Explain why this enhancement would be useful** to most genomesizeR
