---
title: "genomesizeR: Comparing estimation methods"
...
res_wm <- read.csv("results_weighted_mean.csv") %>%
  mutate(confidence_interval_lower = estimated_genome_size - estimated_genome_size_confidence_interval,
         confidence_interval_upper = estimated_genome_size + estimated_genome_size_confidence_interval) %>%
