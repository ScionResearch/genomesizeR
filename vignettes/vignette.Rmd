...
Most of the variation in the hierarchical model is explained by the random effects, which is an issue. A prediction interval is computed using the predictInterval function from the merTools package. 
...
The main steps of both methods are multithreaded. 
